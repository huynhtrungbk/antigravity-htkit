...
Run: python3 .agent/scripts/test-ht-help.py
"""
...
def run_ck_help(*args):
    """Run ht-help.py with given arguments and return output."""
...
def main():
    ...
    tests.append(test_case(
        "config guide",
        ["config"],
        [".ht.json", "Configuration", "locale", "codingLevel"]
    ))
