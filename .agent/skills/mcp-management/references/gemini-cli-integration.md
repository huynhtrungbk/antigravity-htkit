...
Read model from `.agent/.ht.json`: `gemini.model` (default: `gemini-3-flash-preview`)
...
```bash
echo "Search for the agent AI documentation, take a screenshot of the homepage, and save both to memory" | gemini -y -m <gemini.model>
```
