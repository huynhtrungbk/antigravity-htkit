...
Monitor usage limits and context window utilization in real-time to optimize Agent Kit sessions.
...
|----------|--------|----------|
| macOS | Keychain | `Agent Kit-credentials` |
...
|-------|-------|----------|
| No usage limits shown | No OAuth token | Run `agent login` |
