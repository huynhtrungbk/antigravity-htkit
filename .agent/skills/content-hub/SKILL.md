...
Visual asset gallery for Antigravity-HTKit Marketing.

## Quick Start

```bash
# Open gallery
node .agent/skills/content-hub/scripts/server.cjs --open

# Rescan assets
node .agent/skills/content-hub/scripts/server.cjs --scan

# Stop server
node .agent/skills/content-hub/scripts/server.cjs --stop
```
...
- **Actions**: Preview, Edit in the agent, Copy path, Generate new
