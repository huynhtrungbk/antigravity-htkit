...
# Installs all dependencies for Agent Kit skills
#
...
# Show help
function Show-Help {
    Write-Host "Agent Kit Skills Installation Script for Windows"
    Write-Host ""
    Write-Host "Usage:"
...
function Main {
    ...
    Write-Header "Agent Kit Skills Installation (Windows)"
