...
## Prerequisites
- Activate `ui-ux` skill first

## Initial Research
Run `ui-ux` searches:
```bash
python3 .agent/skills/ui-ux/scripts/search.py "<product-type>" --domain product
python3 .agent/skills/ui-ux/scripts/search.py "<style-keywords>" --domain style
python3 .agent/skills/ui-ux/scripts/search.py "<mood>" --domain typography
python3 .agent/skills/ui-ux/scripts/search.py "<industry>" --domain color
```
